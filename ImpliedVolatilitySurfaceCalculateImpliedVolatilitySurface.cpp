/*
	...
	Refactored model versions and referenced: Modeling Derivatives in C++ by Justin London
*/
								 ...
								 map<double, double> rates)
{
	...
	auto error = 0.0; 					// error between market and model prices
	auto vol1 = 0.0; 					// implied volatility
	auto vol2 = 0.0; 					// temporary volatility
	auto vega = 0.0; 					// option vega
	auto BSPrice = 0.0; 					// black scholes pricing
	auto marketPrice = 0.0; 				// market price of instrument
